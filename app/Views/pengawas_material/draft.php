...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Draft Form Material</h3>
        ...
        <table id="draftTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= site_url('pengawas-material/view/' . $form['id']) ?>" class="btn btn-sm btn-info">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="<?= site_url('pengawas-material/edit/' . $form['id']) ?>" class="btn btn-sm btn-warning">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="<?= site_url('pengawas-material/kirim/' . $form['id']) ?>" class="btn btn-sm btn-success" onclick="return confirm('Kirim form ini?')">
                            <i class="fas fa-paper-plane"></i>
                        </a>
                        <button onclick="confirmDelete('<?= site_url('pengawas-material/delete/' . $form['id']) ?>')" class="btn btn-sm btn-danger">
